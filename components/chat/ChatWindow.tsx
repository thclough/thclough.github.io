...
export default function ChatWindow() {
  ...
  return (
    <div>
      ...
      <motion.div
        className="fixed bottom-0 px-6 pb-4 w-full left-1/2 -translate-x-1/2 z-3 bg-white/80 shadow-lg backdrop-blur-[0.5rem] rounded-t-2xl dark:bg-gray-950/50 sm:w-[min(100%,36rem)] sm:right-[5.5rem] hidden-content"
